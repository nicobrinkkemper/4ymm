...
function Level() {
  ...
  const makerPath = (makerName: string, width: number = 500) => `./levelImages/${transformName(makerName)}-${width}.png`
    ...
    <div className="Level">
      <Card>
        ...
        <picture>
          ...
          <img src={`${transformName(level.levelName)}-480.png`} style={{ width: '100%', objectFit: 'cover' }} />
        </picture>
      ...
      <Card>
        ...
        <picture>
                  ...
                  `} />
                  <img src={`${transformName(level.makerName)}-500.png`} style={{ height: '6.125rem', width: '6.125rem', objectFit: 'cover' }} />
                </picture>
      </Card>
    </div>
  )
