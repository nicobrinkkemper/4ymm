...
const newestBatch = releaseDays.indexOf(releaseDays.filter(level=>level.getTime()=>Date.now()).sort((a,b)=>{
  return (a.getTime() - new Date().getTime()) - (b.getTime() - Date.now())
})[0])
  ...
  return (
    <div className="Levels">
      {releaseDays.map((releaseDay,i) => {
        ...
        const isNew = newestBatch === i && releaseDay.getTime() < Date.now()
