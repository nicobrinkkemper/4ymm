...
function Batch() {
  ...
  const makerPath = (makerName: string, width: number = 500) => `./levelImages/${snakeCase(makerName)}-${width}.png`
          ...
          <div className={"LevelCard"}>
            ...
            <div className="info">
              ...
              <div className="levelInfo">
                ...
                <picture>
                  <source srcSet={`
                      ${levelPath(level.levelName, 250)} 250w,
                      ${levelPath(level.levelName, 500)} 500w,
                  `} />
                  <img src={`${level.levelName}-500.png`} style={{ height: '6.125rem', width: '6.125rem', objectFit: 'cover' }} />
                </picture>
