...
export const releaseDays = [
    startDate,
    new Date(Date.parse('5 Jun 2020 15:00:00 GMT')),
...
const createLevel = (levelRow: string[], arr?:string[][], index?:number)=>(
    {
        ...
        batchIndex: Array.isArray(arr) ? levelRow.length : undefined,
    }
)
