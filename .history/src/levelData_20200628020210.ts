...
export const releaseDays = [
    ...
    new Date('5 Jul 2020 15:00:00 GMT'),
    new Date('12 Jul 2020 15:00:00 GMT'),
    new Date('19 Jul 2020 15:00:00 GMT'),
    new Date('26 Jul 2020 15:00:00 GMT'),
]
...
export const isUnreleased = (releaseDay:Date)=>releaseDay.getTime() < Date.now()
export const getLevelData = memoizeOne(() => {
    ...
    const releasedBatches = releaseDays.filter(releaseDay => releaseDay.getTime() < Date.now())
