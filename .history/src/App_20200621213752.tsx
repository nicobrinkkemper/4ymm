...
const BackButton = ()=>{
  ...
  if(typeof batchNumber  === 'string' && typeof order  === 'string')
    return <Button icon="arrow-left" iconPosition="left" to={`{/levels/${batchNumber}`} inverted={true}>Back to {new Intl.DateTimeFormat('en-US', { month: 'long', day: 'numeric' }).format(releaseDays[Number(batchNumber)])}</Button>
