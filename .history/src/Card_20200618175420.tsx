...
export default function Card({ children, illustration }: CardProps) {
    ...
    const hasIllustration = <KEY extends keyof typeof illustrations, RETURN>(_illustration:KEY):RETURN is keyof typeof illustrations=>(_illustration && typeof illustrations[_illustration] === 'object') 
