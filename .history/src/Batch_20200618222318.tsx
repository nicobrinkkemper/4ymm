...
function Batch() {
  const { batchNumberInUrl } = useParams();
  const batchNumber = Number(batchNumberInUrl)-1
  ...
  const batchLevels = levelData.levels.filter(({batchNumber:_batchNumber})=>_batchNumber===batchNumber)
