  ...
  return (
    <div className="Level">
      <Card>
        ...
        <picture>
          <source srcSet={`
                  ${levelPath(level.levelName, 480)} w480,
                  ${levelPath(level.levelName, 960)} w960,
                  ${levelPath(level.levelName, 1280)} w1280,
                  ${levelPath(level.levelName, 1920)} w1920`
          } />
          <img src={`${level.levelName}-480.png`} style={{ width: '100%', objectFit: 'cover' }} />
        </picture>
