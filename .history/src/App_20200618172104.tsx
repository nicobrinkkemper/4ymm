      ...
      <div className="App">
        <div className="ie-fixMinHeight">
          ...
          <footer className="App-footer">
            <Link to="https://discord.gg/yqdgu2Z" rel="noopener noreferrer" target="_BLANK">Discord</a>
            <Link href="https://www.youtube.com/channel/UClayAs7TxVjMbzBLxBbqyoQ" target="_BLANK">Youtube</a>
