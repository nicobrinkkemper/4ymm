...
const unreleasedBatches = releaseDays.filter(level=>level.getTime()<Date.now())
const newestBatch = releaseDays.indexOf(unreleasedBatches.sort((a,b)=>{
  ...
  return (
    <div className="Levels">
      {releaseDays.map((releaseDay,i) => {
        ...
        const isUnreleased = newestBatch === i
