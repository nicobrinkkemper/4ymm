...
function Level() {
  ...
  const makerPath = (makerName: string, width: number = 500) => `./makersImages/${transformName(makerName)}-${width}.png`
    ...
    <div className="Level">
      ...
      <Card>
        ...
        <picture>
                  ...
                  `} />
                  <img src={`./makersImages/${transformName(level.makerName)}-500.png`} style={{ height: '6.125rem', width: '6.125rem', objectFit: 'cover' }} />
                </picture>
      </Card>
    </div>
  )
