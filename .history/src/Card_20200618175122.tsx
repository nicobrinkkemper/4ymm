...
export default function Card({ children, illustration }: CardProps) {
    ...
    const hasIllustration = (illustration && typeof illustrations[illustration] === 'object')
    if (illustration && typeof illustrations[illustration] === 'object') classList.push('hasIllustration')
    return (
        <div className={classList.join(' ')}>
            {(illustration && typeof illustrations[illustration] === 'object') ? <Illustration /> : null}
            {children}
        </div>
    )
}