...
function Level() {
  ...
  const batchLevels = levelData.batch(batchNumber)
  const isUnreleased = levelData.releasedBatches.indexOf(releaseDay) === -1 || strBatchNumber !== Number(level.batchNumber)
