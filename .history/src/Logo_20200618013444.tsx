...
const svgs = {
    "logo_with_card": (<picture className="App-logo-picture">
        <source srcSet={logoWithCard} type="image/svg+xml" />
        <img src={logoWithCardFallback} className="App-logo-img" alt="logo" />
    </picture>),
    "logo_without_card": (<picture className="App-logo-picture">
        <source srcSet={logoWithoutCard} type="image/svg+xml" />
        <img src={logoWithoutCardFallback} className="App-logo-img" alt="logo" />
    </picture>),
}
